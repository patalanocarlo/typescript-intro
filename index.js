...
var numero = 5; // TypeScript deduce che 'numero' è di tipo number
var testo = "Ciao"; // TypeScript deduce che 'testo' è di tipo string
var persona;
persona = {
    nome: "Joel",
    cognome: "Rossi"
};
function trovaPersona(persona) { }
var persona2;
persona2 = {
    nome: "Carlo",
    età: 5
...
function Saluta(persona) {
    console.log("Ciao, ".concat(persona.nome, "! Hai ").concat(persona.età, " anni."));
}
